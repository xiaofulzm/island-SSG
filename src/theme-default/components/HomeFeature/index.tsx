        ...
        return (
            <div key={title} border="rounded-md" p="r-4 b-4" w="1/3"  >
                <article 
                    ...
                    h="full"
                 >
                    <div bg="gray-light-4 dark:bg-white" border="rounded-md" className="md-5 w-12 h-12 text-3xl flex-center"  >{icon}</div>
                    <h2 font="bold" >{title}</h2>
                    <div text="sm text-2" font="medium" className="pt-2 leading-6" >{details}</div>
                </article>
            </div>
        )
    })
